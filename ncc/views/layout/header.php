...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-bee-green shadow">
        <div class="container-fluid">
            <a class="navbar-brand text-white fw-bold me-4" href="<?= BASE_URL_NCC . '?act=dashboard' ?>">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 flex-nowrap">
                    <li class="nav-item">
                        <a href="<?= BASE_URL_NCC . '?act=dashboard' ?>" class="nav-link <?= (empty($_GET['act']) || $_GET['act'] == 'dashboard') ? 'active' : 'text-white' ?>">
                            <i class="bi bi-speedometer2 me-1"></i> Tổng Quan
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= BASE_URL_NCC . '?act=list-danhmuc' ?>" class="nav-link <?= ($_GET['act'] ?? '') == 'list-danhmuc' ? 'active' : 'text-white' ?>">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark shadow">
                            <li><a class="dropdown-item" href="<?= BASE_URL_NCC . '?act=list-tours' ?>">Tất cả Tour</a></li>
                            <li><a class="dropdown-item" href="<?= BASE_URL_NCC . '?act=list-tours&loai_tour=1' ?>">Tour Trong Nước</a></li>
                            <li><a class="dropdown-item" href="<?= BASE_URL_NCC . '?act=list-tours&loai_tour=2' ?>">Tour Nước Ngoài</a></li>
                            <li><a class="dropdown-item" href="<?= BASE_URL_NCC . '?act=list-tours&loai_tour=3' ?>">Tour Theo Yêu Cầu</a></li>
                        </ul>
                    </li>

                    <li class="nav-item">
                        <a href="<?= BASE_URL_NCC . '?act=quan-ly-booking' ?>" class="nav-link <?= (strpos($_GET['act'] ?? '', 'booking') !== false) ? 'active' : 'text-white' ?>">
                            <i class="bi bi-book me-1"></i> Quản Lý Booking
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= BASE_URL_NCC . '?act=list-nhacungcap' ?>" class="nav-link <?= ($_GET['act'] ?? '') == 'list-nhacungcap' ? 'active' : 'text-white' ?>">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark shadow">
                            ...
                            <li><a class="dropdown-item" href="<?= BASE_URL_NCC . '?act=logout-admin' ?>">Đăng Xuất</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
