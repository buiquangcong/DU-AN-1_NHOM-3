...
class AdminquanlytourController {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (empty($error)) {
                $insertId = $this->modelSanPham->insertSanPham(
                    ...
                    $SoNgay, $SoDem, $NoiDungTomTat, $NoiDungChiTiet,
                    $NgayKhoiHanh, $DiemKhoiHanh, $SoCho, $TrangThai
                );
                ...
                if ($insertId) {
                    ...
                    header("Location: index.php?act=add-tour");
                    exit;
                }
            } else {
                header("Location: index.php?act=add-tour");
    ...
    public function formEditSanPham($id) {
        ...
        $listDanhmuc = $this->modelDanhMuc->getAllDanhMuc();
        require_once __DIR__ . '/../views/layout/header.php';
        require_once __DIR__ . '/../views/tour/editTour.php';
        require_once __DIR__ . '/../views/layout/footer.php';
    }
