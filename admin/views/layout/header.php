    ...
    <div class="wrapper">
        <nav class="sidebar d-flex flex-column p-3 text-white">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="index.php?act=list-danhmuc" class="nav-link text-white" aria-current="page">
                        <i class="bi bi-map me-2"></i> Quản Lý Danh Mục Tour
                    </a>
                </li>
                <li>
                    <a href="index.php?act=list-tours" class="nav-link text-white " aria-current="page">
